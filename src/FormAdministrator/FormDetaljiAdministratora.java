...
public class FormDetaljiAdministratora extends javax.swing.JDialog {
    ...
    public FormDetaljiAdministratora(JDialog parent, boolean modal, Administrator a) {
        ...
        this.a = a;
        lblID.setText("AdministratorID: " + String.valueOf(a.getAdministratorID()));
    ...
    public FormDetaljiAdministratora(JFrame parent, boolean modal, Administrator a) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(null);
        this.a = a;
    ...
    private void btnIzmeniActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIzmeniActionPerformed
        ...
        try {
            ...
            if (!(getParent() instanceof JFrame)) {
                ...
                JOptionPane.showMessageDialog(this, "Uspesno ste izmenili svoje podatke!");
            }
            this.dispose();
        } catch (Exception ex) {
        ...
        if (result == JOptionPane.YES_OPTION) {
            try {
                ...
                if (!(getParent() instanceof JFrame)) {
                    ...
                    JOptionPane.showMessageDialog(this, "Uspesno izbrisan nalog. Dovidjenja!");
